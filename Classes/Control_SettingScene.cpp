...
//void ControlSettingScene::menuCallback(Ref* pSender, cocos2d::ui::Widget::TouchEventType type) {
//	
//		auto item = dynamic_cast<MenuItemToggle*>(pSender);
//		if (item) {
//			if (item->getSelectedIndex() == 0) {
//				CCLOG("Play sound");
//				SimpleAudioEngine::getInstance()->playBackgroundMusic("g_bgmPlayingusic.wav", true);
//				//_audioID=AudioEngine::play2d("g_bgmPlayingusic.wav", true);
//			}
//			else if (item->getSelectedIndex() == 1) {
//				log("Silence");
